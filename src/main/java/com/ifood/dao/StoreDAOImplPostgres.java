...
public class StoreDAOImplPostgres implements StoreDAO {
    ...
    public boolean register(Store store) {
        ...
        try {
            ...
            String sql = Query.fileToString("/postgres/store_register.sql");
    ...
    public boolean update(Store store) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("/postgres/store_update.sql");
            stmt = (connection.prepareStatement(sql));
    ...
    public List<Store> getAll() {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("/postgres/store_get_all.sql");
            stmt = connection.prepareStatement(sql);
    ...
    public Store getOne(int storeId) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("/postgres/store_get_one.sql");
            stmt = connection.prepareStatement(sql);
    ...
    public boolean delete(int id) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("/postgres/store_delete.sql");
            stmt = connection.prepareStatement(sql);
            stmt.setInt(1, id);
            stmt.executeUpdate();
            return true;
    ...
    public int getLastId() {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("/postgres/store_last_id.sql");
            stmt = connection.prepareStatement(sql);
            result = stmt.executeQuery();
            if (result.next()) {
