...
public class ResponsibleDAOImplOracle implements ResponsibleDAO {
    ...
    public boolean register(Responsible responsible) {
        ...
        try {
            ...
            String sql = Query.fileToString("oracle_responsible_register.sql");
    ...
    public boolean update(Responsible responsible) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle_responsible_update.sql");
            stmt = (connection.prepareStatement(sql));
    ...
    public Responsible getOne(int responsibleId) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle_responsible_get_one.sql");
            stmt = connection.prepareStatement(sql);
    ...
    public boolean delete(int id) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle_responsible_delete.sql");
            stmt = connection.prepareStatement(sql);
            stmt.setInt(1, id);
            stmt.executeUpdate();
            return true;
