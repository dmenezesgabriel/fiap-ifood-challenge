...
public class ContactDAOImplOracle implements ContactDAO {
    ...
    public boolean register(Contact contact) {
        ...
        try {
            ...
            String sql = Query.fileToString("oracle/contact_register.sql");
    ...
    public boolean update(Contact contact) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle/contact_update.sql");
            stmt = (connection.prepareStatement(sql));
    ...
    public List<Contact> getAll() {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle/contact_get_all.sql");
            stmt = connection.prepareStatement(sql);
    ...
    public Contact getOne(int contactId) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle/contact_get_one.sql");
            stmt = connection.prepareStatement(sql);
    ...
    public boolean delete(int id) {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle/contact_delete.sql");
            stmt = connection.prepareStatement(sql);
            stmt.setInt(1, id);
            stmt.executeUpdate();
            return true;
    ...
    public int getLastId() {
        ...
        try {
            connection = ConnectionManager.getInstance().getConnection();
            String sql = Query.fileToString("oracle/contact_last_id.sql");
            stmt = connection.prepareStatement(sql);
            result = stmt.executeQuery();
            if (result.next()) {
